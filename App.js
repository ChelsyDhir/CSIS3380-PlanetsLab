...
const Planet = (props) => {
  ...
  //   let planets = planets.filter((d) => d.id !== id);
  //   // setPlanets(newList);
  //   // planets.splice(id);
  //   planets = newList
  //   console.log("delete");
  //   // console.log(planets.splice(id));//getting all the planets except the deleted one
  //   console.log(planets);//deleted planet
  // }
...
class Container extends React.Component {
  ...
  //function to delete the component and preserve the state
  deletePlanet = (id) => {
